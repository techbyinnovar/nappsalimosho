                ...
                <div className="hidden md:flex gap-8">
                    {session ? (
                        <>
                            ...
                            <button onClick={() => signOut()} className="text-lg font-semibold text-green-700 hover:underline cursor-pointer">Logout</button>
                        </>
                        ) : (
                        <button onClick={() => signIn()} className="text-lg font-semibold text-green-700 hover:underline cursor-pointer">Login</button>
                        )}
