// components/ZoneStatistics.tsx
export default function ZoneStatistics() {
    const zones = [
        { id: "Alimosho Central", schools: 56 },
        { id: "Agbado/Oke-Odo", schools: 39 },
        { id: "Ayobo/Ipaja", schools: 36 },
        { id: "Egbe/Idimu", schools: 70 },
        { id: "Ikotun/Igando", schools: 27 },
        { id: "Mosan-Okunola", schools: 4 },
        { id: "Egbeda", schools: 35 },
    ];
    ...
    return (
        <div className="text-center pt-12">
            <div>
                ...
                <p className="text-center text-gray-600 text-xl max-w-3xl mx-auto mb-12">
                Overview of registered schools across all zones.
                </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-7 gap-4">
                ...
                >
                    <h3 className="text-lg font-semibold text-green-800">{zone.id}</h3>
