              ...
              <tbody>
                {paginated.map((school) => (
                  <tr key={school.id} className="border-t hover:bg-green-50">
                    ...
                    <td className="py-2 px-4">
                      {school.ownerFirstName} {school.ownerLastName}
                    </td>
                    <td className="py-2 px-4">{school.ownerEmail}</td>
                    <td className="py-2 px-4">{school.ownerPhone || "—"}</td>
            ...
            {paginated.map((school) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-700 text-sm">
                    <strong>Owner:</strong> {school.ownerFirstName} {school.ownerLastName}
                  </p>
                  <p className="text-gray-700 text-sm">
                    <strong>Email:</strong> {school.ownerEmail}
                  </p>
                  <p className="text-gray-700 text-sm">
                    <strong>Phone:</strong> {school.ownerPhone || "—"}
                  </p>
...
// import { useRouter } from "next/navigation";
// import { FaEdit, FaTrash, FaToggleOn, FaToggleOff } from "react-icons/fa";
// import RegisterSchoolModal from "@/components/RegisterSchoolModal"; // ✅ import modal
...
//   const [selectedSchool, setSelectedSchool] = useState<School | null>(null);
//   const [modalMode, setModalMode] = useState<"create" | "edit">("create");
//   const [isModalOpen, setIsModalOpen] = useState(false); // ✅ renamed
...
//     setSelectedSchool(school);
//     setModalMode("edit");
//     setIsModalOpen(true); // ✅ opens the external modal
//   };
